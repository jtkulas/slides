...
xaringanExtra::use_scribble()          ## page load times much worse with this enabled
...
<div class="my-footer"><span>ergweb.netlify.app</span></div>
...
# .white[Feedback Report <br>Slides Tutorial]

<img src="erg5.png" alt="Sharingan" width="180" />

### .white[.large[.fancy[Using e`r fa("r-project")`g <br>feedback slides]]]

.white[John-o Kulas | e`r fa("r-project")`g | `r Sys.Date()`]
...
# .center[.salt[.fancy[Find us at...]]]

.pull-left[
<img class="circle" src="img/kulas.jpg" width="200px"/>

[`r fa(name = "twitter")` @jtkulas](http://twitter.com/jtkulas)  
[`r fa(name = "github")` jtkulas](http://github.com/jtkulas)  
[`r fa(name = "link")` e`r fa("r-project")`g](https://ergweb.netlify.com)  
[`r fa(name = "paper-plane")` jtkulas@ergweb.com](mailto:jtkulas@ergweb.com)
]  
...
Press `h` or `?` to see the keyboard shortcuts to aid your slide presentation. 
...
When you are in presenter mode, you see your notes but your audience does not! 
...
.left-column[
# Have you also noticed the <br> .fat[.fancy["Pencil"?]] `r anicon::faa("pencil-alt", animate="wrench")`
]
