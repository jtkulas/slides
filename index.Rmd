...
# Feedback Report <br>Slides Tutorial

<img src="erg5.png" alt="Sharingan" width="180" />

### .fancy[Using erg <br>feedback slides]

John Kulas | erg | `r Sys.Date()`
...
.pull-left[
<img class="circle" src="img/kulas.jpg" width="150px"/>

# Find us at...

[`r fa(name = "twitter")` @jtkulas](http://twitter.com/jtkulas)  
[`r fa(name = "github")` @jtkulas](http://github.com/jtkulas)  
[`r fa(name = "link")` jtkulas.rbind.io](https://jtkulas.rbind.io)  
[`r fa(name = "paper-plane")` jtkulas@ergweb.com](mailto:kulasj@ergweb.com)
]

.pull-right[
<img src="img/tutor.jpg" height="500px"/>
]
...
Press `h` or `?` to see the [keyboard shortcuts](https://bookdown.org/yihui/rmarkdown/xaringan-key.html). 
