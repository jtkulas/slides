...
Press your keyboard's .fancy[.large[.neon["H"]]] key <br> to view presentation options. 
...
.pull-right[
.large[Take some time to test out some of these options:]  
...
.pull-left[
...also note the difference in groupings between options for  .large[.bluecircle[navigation]]... 
...
.pull-right[
...and options for .large[.redbracket[presentation]]
...
# We'll just be focusing on how to use a few of the most popular .large[.redbracket[presentation]] options:
